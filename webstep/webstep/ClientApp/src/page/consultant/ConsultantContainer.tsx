...
interface ConsultantContainerProps {
  onClose: (val: string) => void;
}

export const ConsultantContainer: React.FC<ConsultantContainerProps> = ({
  onClose,
}) => {
  ...
  const filterConsultant = (e: React.ChangeEvent<HTMLInputElement>) => {
