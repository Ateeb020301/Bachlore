...
import {
  getAddSubProspectInput,
  getDefaultNewSubProspect,
} from "../../../api/prospects/logic";
...
export const SubProspectEvents: React.FC<SubProspectEventsProps> = ({
  subProspects,
  sellerId,
  prospectId,
}) => {
