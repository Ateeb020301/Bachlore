...
export const SubProspectEventContainer: React.FC<
  SubProspectEventContainerProps
> = ({ subProspect, sellerId }) => {
  const [editSubProspect] = useMutation<
    EditSubProspectPayload,
    { input: EditSubProspectInput }
  >(EDIT_SUBPROSPECT, {
    refetchQueries: [
      {
