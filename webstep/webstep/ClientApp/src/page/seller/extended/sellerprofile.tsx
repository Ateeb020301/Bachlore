                ...
                <Box className={'column'}>
                                ...
                                <Box className={'welcomeInitials'}>
                                    <Box className="img" sx={{ mr: 2, padding: '5px', background: '#f2f6f8', border: 'solid', borderColor: '#ecefee', borderWidth: 'thin', borderRadius: '100%', height: '50px', width: '50px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                        <Box sx={{ border: 'solid', borderRadius: '100%', borderColor: '#ecefee', borderWidth: 'thin', width: '100%', height: '50px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                            <p style={{ color: '#6a96e9', fontWeight: 900, fontSize: '14px', letterSpacing: '1px' }}>{`${data?.seller[0].fullName.substring(0, 1)}` }</p>
                                        </Box>
                                    </Box>
                                   <Box sx={{pl: 1}}>
                                        <p style={{fontSize: '15px', fontWeight: 600, marginTop: '10px'}}>{data?.seller[0].fullName}</p>
                                        <p style={{fontSize: '12px', opacity: .5, marginTop: '5px'}}>--------</p>
                                   </Box>
                                </Box>

                                <Box sx={{mt: 2, textAlign: 'center'}}>
                                    <p style={{fontWeight: 600}}>{data?.seller[0].prospects.length}</p>
                                    <p style={{opacity: .5}}>Prospects</p>
                                </Box>
                    ...
                    <Box className={'infoBox'} sx={{my: 2, py:1, borderRadius: '3px'}}>
                        <Box sx={{pl: 2, pt: .5, pb: 1, borderBottom: 'solid', borderWidth: 'thin', borderColor: '#f6f7fb'}}>
                            <p style={{fontWeight: 600, letterSpacing: '1px'}}>Seller Information</p>
                        </Box>
                        <Box sx={{mx: 2, py:2, borderBottom: 'solid', borderWidth: 'thin', borderColor: '#f6f7fb', display: 'flex'}}>
                            ...
                            <p style={{flex: 1, fontWeight: 400, letterSpacing: '1px', opacity: .7}} className={'infoText'}>{data?.seller[0].fullName}</p>
                        </Box>
                        <Box sx={{mx: 2, py:2, borderBottom: 'solid', borderWidth: 'thin', borderColor: '#f6f7fb', display: 'flex'}}>
                            <p style={{flex: 1, fontWeight: 600, letterSpacing: '1px'}}>Employment Date:</p>
                            <p style={{flex: 1, fontWeight: 400, letterSpacing: '1px', opacity: .7}} className={'infoText'}>{data?.seller[0].employmentDate}</p>
                        </Box>
                        {data?.seller[0].resignationDate ? (
                            <Box sx={{mx: 2, py:2, borderBottom: 'solid', borderWidth: 'thin', borderColor: '#f6f7fb', display: 'flex'}}>
                                <p style={{flex: 1, fontWeight: 600, letterSpacing: '1px'}}>Resignation Date:</p>
                                <p style={{flex: 1, fontWeight: 400, letterSpacing: '1px', opacity: .7}} className={'infoText'}>{data?.seller[0].resignationDate}</p>
                            </Box>
                        ) : (<></>)}
                        <Box sx={{mx: 2, py:2,  display: 'flex'}}>
                            <p style={{flex: 1, fontWeight: 600, letterSpacing: '1px'}}>Email:</p>
                            <p style={{flex: 1, fontWeight: 400, letterSpacing: '1px', opacity: .7}} className={'infoText'}>{data?.seller[0].email}</p>
                        </Box>
                    </Box>
                </Box>
