...
export const ConsultantSection: React.FC<ConsultantSectionProps> = ({ consultantId, showContracts }) => {
    return (
        <>
            <ConsultantCapacityRow consultantId={consultantId} />
            {showContracts && <ConsultantContractRowList consultantId={consultantId} />}
        </>
    );
};
