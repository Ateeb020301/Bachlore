...
export const AddVacancyButton: React.FC<AddVacancyButtonProps> = ({ consultantId, planned }) => {
    const pointlessConsultantIdCopy = consultantId; //only god knows why this is necessary

    const [addVacancy] = useMutation<AddVacancyPayload, { input: AddVacancyInput }>(ADD_VACANCY, {
        refetchQueries: [
            {
