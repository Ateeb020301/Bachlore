...
import { AddCustomerPayload, ADD_CUSTOMER, GET_CUSTOMER, CustomerPayload } from '../../api/customer';
          ...
          {data?.customers.items ? (
              <Box sx={{ display: 'flex', flexWrap: 'wrap', mt: 2}}>
                  ...
                  <Box sx={{display: 'flex', flexBasis: '100%', m: 1}}>
                      <Box className={'table'} sx={{flex: 3, mr: 1, boxShadow: '0px 0px 3px 0px rgba(0,0,0,0.1)', borderRadius: '5px', alignSelf: 'self-start', background: '#ffffff'}}>
                          <TableContainer>
                      ...
                      <Box sx={{flex: 1, borderRadius: '5px', ml: 1, boxShadow: '0px 0px 3px 0px rgba(0,0,0,0.1)', alignSelf: 'self-start', background: '#ffffff'}}>
                          {GetInfo(inpCustomer)}
                      </Box>
                  </Box>
              </Box>
